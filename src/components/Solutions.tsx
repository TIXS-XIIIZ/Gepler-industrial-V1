  ...
  return (
    <section
      ...
      className={`py-24 md:py-32 overflow-hidden transition-colors duration-300 ${
        isDark ? 'bg-[#0E0E0E] text-white' : 'bg-[#F8F7F4] text-[#111111]'
      }`}
    >
      <div className="max-w-[1180px] w-[calc(100%-48px)] mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <span
              className={`text-xs font-bold uppercase tracking-[0.18em] ${
                isDark ? 'text-[#8E8E8E]' : 'text-[#5F5F5F]'
              }`}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p
              className={`max-w-[420px] text-sm md:text-base leading-relaxed m-0 ${
                isDark ? 'text-[#888888]' : 'text-[#555048]'
              }`}
            >
        ...
        <div
          className={`hidden md:block relative min-h-[580px] py-16 px-10 border-y ${
            isDark ? 'border-white/10' : 'border-[#E2DDD5]'
          }`}
        >
          {/* Connection Lines (SVG) with animated draw - Kept exactly as original per instruction */}
          <svg
          ...
          <motion.div
            ...
            className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-48 h-48 rounded-full border border-[#F26A21] flex flex-col items-center justify-center shadow-[0_0_50px_rgba(242,106,33,0.22)] px-4 text-center group cursor-pointer transition-colors duration-300 ${
          ...
          >
            ...
            />
            <div className="w-14 h-auto flex items-center justify-center mb-0.5 transition-transform group-hover:scale-110">
              <GeplerLogo variant="body" size="sm" />
            </div>
            <span
            ...
            <span
              className={`text-[0.68rem] font-medium mt-1 text-center leading-tight ${
                isDark ? 'text-[#FFC928]' : 'text-[#D97706]'
              }`}
            >
              เลือกพัฒนาเฉพาะระบบ
              <br />
              ...
              className={`max-w-[280px] p-4 transition-all duration-300 cursor-pointer rounded border ${
                activeSolution === 1
                  ? isDark
                    ...
                    : 'bg-white border-[#F26A21] -translate-y-1 shadow-lg'
                  : isDark
            ...
            >
              ...
              <p
                className={`text-sm leading-relaxed ${
                  isDark ? 'text-[#8B8B8B]' : 'text-[#5F5B54]'
                }`}
              >
        ...
        <motion.div
          ...
          className={`hidden md:flex items-center justify-center gap-2 mt-8 text-xs ${
            isDark ? 'text-[#8E8E8E]' : 'text-[#6B665F]'
          }`}
        >
        ...
        <div
          className={`md:hidden flex flex-col divide-y ${
            isDark ? 'divide-white/10' : 'divide-[#E2DDD5]'
          }`}
        >
          <div
            className={`py-3 px-3.5 border rounded-sm mb-4 text-xs font-medium ${
              isDark
                ...
                : 'bg-[#F26A21]/10 border-[#F26A21]/20 text-[#D97706]'
            }`}
          >
          ...
          {solutions.map((item, index) => (
            ...
            >
              ...
              <h3
                className={`text-xl font-bold mt-1.5 mb-2 ${
                  isDark ? 'text-white' : 'text-[#111111]'
                }`}
                style={{ fontFamily: 'var(--display)' }}
              >
