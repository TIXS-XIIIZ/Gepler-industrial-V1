      ...
      <div className="max-w-[1180px] w-[calc(100%-48px)] mx-auto">
        ...
        <ol
          className={`list-none p-0 m-0 border-t ${
            isDark ? 'border-white/15' : 'border-[#E2DDD5]'
          }`}
        >
          {steps.map((step, index) => (
            ...
            >
              ...
              <div>
                ...
                <p
                  className={`text-sm sm:text-base m-0 transition-colors group-hover:text-[#3A1D0D] ${
                    isDark ? 'text-[#888888]' : 'text-[#5F5B54]'
                  }`}
                >
                  {step.desc}
                </p>
              ...
              <span
                className={`text-lg sm:text-xl font-mono group-hover:text-black group-hover:translate-x-1 transition-all ${
                  isDark ? 'text-[#666666]' : 'text-[#8E887E]'
                }`}
              >
                ↗
              </span>
