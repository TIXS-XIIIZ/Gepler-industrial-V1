    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full bg-[#141414]/90 backdrop-blur-md border border-white/15 text-white flex items-center justify-center shadow-[0_8px_25px_rgba(0,0,0,0.6)] hover:border-[#F26A21] hover:text-[#F26A21] transition-colors cursor-pointer group"
        >
