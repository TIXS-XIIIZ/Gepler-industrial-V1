      ...
      <div className="relative z-10 max-w-[1180px] w-[calc(100%-48px)] mx-auto grid grid-cols-1 lg:grid-cols-[1.25fr_0.75fr] gap-12 lg:gap-20 items-end">
        ...
        <div className="max-w-[500px]">
          ...
          <button
            ...
            id="brief-open-btn"
            onClick={onOpenBrief}
            className="w-full sm:w-auto inline-flex items-center justify-between gap-8 px-8 py-4.5 bg-[#111111] hover:bg-[#252525] text-white font-bold text-sm tracking-wider uppercase transition-all duration-200 hover:-translate-y-0.5 cursor-pointer shadow-xl"
          >
